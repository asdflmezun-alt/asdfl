(function () {
  ...
  const documents = {
    'kvkk-aydinlatma': {
      ...
      sections: [
        ['Veri Sorumlusu', '<p>6698 sayılı Kişisel Verilerin Korunması Kanunu kapsamında veri sorumlusu Afyon Süleyman Demirel Fen Lisesi Mezunlar Derneğidir ("Dernek").</p>'],
        ...
        ['Haklarınız', '<p>KVKK m.11 kapsamında verilerinizin işlenip işlenmediğini öğrenme, bilgi talep etme, amacına uygun kullanımı öğrenme, aktarılan kişileri öğrenme, düzeltme, silme veya yok etme isteme, otomatik analiz sonuçlarına itiraz etme ve zararın giderilmesini isteme haklarına sahipsiniz.</p>']
      ]
    },
    'acik-riza': {
      ...
      sections: [
        ...
        ['Rızanın Geri Çekilmesi', '<p>Rızamı profil ayarlarından veya veri başvurusu oluşturarak dilediğim zaman ileriye etkili şekilde geri çekebilirim. Geri çekme öncesinde rızaya dayalı gerçekleştirilen işlemler bundan etkilenmez.</p>']
      ]
    },
    'gizlilik-politikasi': {
      title: 'Gizlilik Politikası',
      sections: [
        ['Kapsam', '<p>Bu politika, ASDFL Mezunlar Derneği platformunun ziyaretçi ve üyelerine ait bilgileri nasıl topladığını, kullandığını, koruduğunu ve hangi tercihlerle yönetilebildiğini açıklar.</p>'],
        ...
        ['Tercihleriniz', '<p>Profil paylaşım tercihlerinizi değiştirebilir, açık rızanızı geri çekebilir ve bilgi, düzeltme, kopya veya silme talebi oluşturabilirsiniz.</p>']
      ]
    },
    'cerez-politikasi': {
      title: 'Çerez ve Yerel Depolama Politikası',
      sections: [
        ['Kullanılan Teknolojiler', '<p>Platform, oturumun korunması ve kullanıcı deneyiminin sürdürülebilmesi için Supabase oturum anahtarları ile tarayıcının localStorage veya sessionStorage alanını kullanır.</p>'],
    ...
    'kullanim-kosullari': {
      ...
      sections: [
        ['Amaç ve Üyelik', '<p>Platform mezunları, öğrencileri ve okul topluluğunu bir araya getirmek için sunulur. Kullanıcılar doğru ve güncel bilgi vermeyi, hesap güvenliğini korumayı ve başka kişilerin hesabını kullanmamayı kabul eder.</p>'],
    ...
    'veri-basvuru-silme': {
      ...
      sections: [
        ...
        ['Başvuru Yöntemi', '<p>Giriş yapan kullanıcılar profil sayfasındaki “Gizlilik ve Verilerim” bölümünden başvuru oluşturabilir. Ayrıca aşağıdaki kurumsal iletişim kanalı kullanılabilir. Kimlik doğrulaması için ek bilgi istenebilir.</p>'],
